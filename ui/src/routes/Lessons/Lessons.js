...
class Lessons extends Component {
  ...
  render () {
    ...
    return (
      <DocumentTitle title={`${this.props.unitName} | Clix Modules`}>
          ...
          <header className='c-breadcrumbs__header'>
            <nav className='c-breadcrumbs__nav'>
              <ul className='c-breadcrumbs__list'>
                ...
                <li>
                  <BreadcrumbChevron />
                  <a onClick={this._onHandleSelectLesson} href={`/subjects/${this.props.subjectName}/grades/${this.props.unitName}`} aria-current='page'>{this.props.strings.breadcrumbs.selectLesson}</a>
                </li>
              </ul>
            </nav>
          </header>
