...
// - start removed so collapse btn won't show up
const COLLAPSABLES = ['drum', 'action', 'matrix'];//'start', 
...
function Block(protoblock, blocks, overrideName) {
    ...
    this.hide = function(permanent) {
        ...
        if(permanent) {
            if (this.collapseContainer !== null) {
                this.removeChild(this.collapseContainer);
            }
